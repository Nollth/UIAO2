...
public class ModItems {
    ...
    public static final RegistryObject<Item> MAGMA_BUCKET =  ITEMS.register("magma_bucket",
            () -> new BucketItem(() -> Fluids.LAVA, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)){
                    @Override
    public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entity) {
        if (!entity.isInvulnerable()) {
            entity.setInvulnerable(true);
    ...
    public static final RegistryObject<Item> WARM_MILK_BUCKET =  ITEMS.register("warm_milk_bucket",
            () -> new WarmMilkBucketItem(new Item.Properties().food(ModFoods.WARM_MILK_BUCKET).craftRemainder(Items.BUCKET).stacksTo(1)){
                    @Override
    public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entity) {
        if (!entity.isInvulnerable()) {
            entity.setInvulnerable(true);
