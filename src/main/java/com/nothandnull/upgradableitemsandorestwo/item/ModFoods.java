...
public class ModFoods {
    ...
    public static final FoodProperties FRIED_FLESH = new FoodProperties.Builder().nutrition(16).saturationMod(3.2f).build();

    public static final FoodProperties FLESH = new FoodProperties.Builder().nutrition(8).saturationMod(1.6f)
            .effect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.3f)
            .effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 600, 0), 0.3f)
            .build();

    public static final FoodProperties WARM_MILK_BUCKET = new FoodProperties.Builder().nutrition(5).saturationMod(5.0f).build();
