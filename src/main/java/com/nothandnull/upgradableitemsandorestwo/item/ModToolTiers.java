...
public class ModToolTiers {
    public static final Tier BLOOD = TierSortingRegistry.registerTier(
            new ForgeTier(0, 10, 1.0F, 1.0F, 0,
                    ModTags.Blocks.NEEDS_BLOOD_TOOL, () -> Ingredient.of(ModItems.BLOOD_TEARS.get())),
            new ResourceLocation(UpgradableItemsAndOresTwo.MOD_ID, "blood"), List.of(Tiers.WOOD), List.of());
